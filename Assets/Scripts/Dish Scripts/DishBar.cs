...
public class DishBar : MonoBehaviour
{
    ...
    public DishSpawn dishSpawn;

    private void Awake()
    {
        dishSpawn = GameObject.Find("DishButton").GetComponent<DishSpawn>(); //Get script
    }
    ...
    public IEnumerator IncreaseDishBar()
    {
